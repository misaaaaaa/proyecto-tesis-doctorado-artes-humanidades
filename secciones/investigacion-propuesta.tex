...
Esta práctica artística y académica es una mezcla de confluencias y contradicciones, donde se aspira a no ser aspiracional, a popularizar la producción de ruido para fines artísticos, a promover el goce del sonido desatado en distintas materialidades, a valorar la infraestructura que nos permite sonar y escuchar.
...
En industria y en español existe muchas veces una amalgama entre conceptos como sintetizadores y teclados, pero en esta tesis nos concentraremos en otros tipos de interfaces \footcite{bjorn_push_2021}.

En la industria de la síntesis también existe mucho énfasis en música, lo que está divorciado del origen artístico e investigativo de muchas personas pioneras del siglo XX que expandieron el campo del arte sonoro y sentaron las bases conceptuales, electrónicas y computacionales \footcite{roads_computer_1996} que permiten la emergencia de un amplio abanico de sintetizadores actuales.
...
\subsection{Critter and Guitari}
